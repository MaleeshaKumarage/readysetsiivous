      ...
      <div className="container-page py-10 sm:py-12">
        <Reveal className="flex flex-col sm:flex-row items-center justify-between gap-6 max-w-4xl mx-auto">
          <div className="text-center sm:text-left">
            ...
            <p className="mt-2 text-sm text-amber-700 dark:text-amber-400 max-w-lg">
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center gap-2 px-6 py-3.5 bg-whatsapp text-white text-sm font-bold rounded-full hover:bg-whatsapp-dark transition-all shadow-lg shadow-green-200 dark:shadow-green-900/30 hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0"
          >
