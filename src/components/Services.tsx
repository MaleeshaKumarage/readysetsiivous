    ...
    <section id="services" className="bg-gray-50 dark:bg-gray-900 section-padding">
      <div className="container-page">
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICE_CARDS.map(({ key, icon, gradient, bg }) => (
            <div
              key={key}
              className="group relative bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm dark:shadow-gray-950/30 hover:shadow-xl dark:hover:shadow-gray-950/50 hover:-translate-y-1 transition-all duration-300 p-6 flex flex-col"
            >
